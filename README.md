...
| **`/doc/`** | **제출용 사업제안서** (A4 23쪽) ★ | **도청 제출 정본.** 행정 문서 형식. 예산 산출, 추진체계, 중복 검토, 성과지표·종료조건, 법령·책임 검토를 담았습니다. 브라우저 인쇄로 PDF 출력 |
| `/v2/` | 제안서 v2 (19장) | **시연용.** 기능 동작을 브라우저에서 직접 보여줄 때 사용합니다. 12번 슬라이드 시뮬레이터가 핵심 |
